...
% load data
load([ReadPath 'fluo_bin_particle_ids.mat'],'particle_id_cell')
fluo_bin_results  = readtable([ReadPath 'fluo_bin_results_full_final.csv']);
load([RawPath 'inference_traces_w_stripe_ids.mat'],'trace_struct_final')
% load old hmm results for comparison
hmm_results = readtable("E:\Nick\projects\all_the_stripes_cd\dat\eve7stripes_inf_2018_04_28\w7_t20_alpha14_f1_cl1_no_ends1_tbins1\K3_summary_stats\eve_hmm_summary_K3.csv");
...
writetable(stripe_table_new,[ReadPath 'stripe_hmm_results_final.csv'])